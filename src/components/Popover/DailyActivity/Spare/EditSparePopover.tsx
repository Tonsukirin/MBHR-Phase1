...
import InputSearchList from '@/components/InputSearchList/InputSearchList';
...
export interface EditSparePopoverInputData {
  OT1_5?: number;
  OT2?: number;
  OT3?: number;
  lateMinutes?: number;
...
export interface EditSparePopoverProps {
  children: React.ReactNode;
  date: Dayjs;
  employeeName: string;
  employeeId: string;
  status: StatusOption;
  onSave: (inputData: EditSparePopoverInputData) => void;
  onCancel: () => void;
}

const EditSparePopover: React.FC<EditSparePopoverProps> = ({
  children,
  date,
  employeeId,
  employeeName,
      ...
      content={
        <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-col gap-2">
            <span>เข้าทำงานที่เคส</span>
            <InputSearchList type="contract" />
          </div>

          <div className="flex justify-between items-center gap-10">
            <span className="w-[100px] text-nowrap">ค่าแรงแม่บ้าน (สแปร์)</span>
            <Input
...
export default EditSparePopover;
